...
**Le plan d'implémentation est `docs/plan-f1-dependance.md` — VALIDÉ
(GO, second arbitrage du 2026-08-29, trois conditions et une porte de
calendrier inscrites au plan). Séquence : F1.0 registre
`FUNDER_PROFILE` (lot 4 de l'audit — prérequis maintenu, et pas avant
la CI verte) → F1.1 dette Explorateur → F1.2 moteur M1-M4 → F1.3
M5-M6 → F1.4 surfaces.**
