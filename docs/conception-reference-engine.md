...
| D16 | R1 = Nominal + Real + nouvelle grammaire + sélecteur, publication rapide. R2 = Index 100 + croissance (transformation côté client). R3 = juridictions + % PIB + par habitant. R4 = PPP après étude d'agrégation. R5 = dénominateurs système après étude comptable. |
...
**Le problème méthodologique, explicitement :** Orion observe des **cohortes d'engagement** — des montants totaux pluriannuels rattachés à l'année civile de début du projet (conventions ①②③). Un budget est une **dépense annuelle** — crédits d'engagement ou de paiement, année budgétaire (fiscale pour NIH/NSF, exercice pour l'UE). Diviser l'un par l'autre produit un ratio dont le numérateur et le dénominateur ne comptent ni la même chose, ni sur le même axe du temps : cohorte d'engagement ≠ dépense annuelle.
...
S'y ajoutent deux blocages de source indépendants : la GERD absolue UIS est discontinuée (archive mars 2021) et sous clause ShareAlike ; le MSTI OCDE est gelé jusqu'au 31/03/2027. R5 ne s'ouvre qu'après cette étude — et peut légitimement conclure « non ».
...
### R5 — Dénominateurs « système de financement »

Uniquement après l'étude comptable de la porte D12 (les quatre exigences), et sous réserve des blocages de sources (UIS ShareAlike, MSTI gelé jusqu'en 2027). Peut légitimement conclure à l'abandon.
