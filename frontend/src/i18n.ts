...
const resources = {
  en: {
    translation: {
      ...
      home: {
        spaceKicker: "The space lens",
        spaceTitle: "The space sector, identified in the corpus",
        spaceLead:
          "A versioned lens tags every project on evidence — space at the core, enabling technologies adjacent. Nothing inflated, nothing removed.",
        spaceCore_one: "core space project",
        spaceCore_other: "core space projects",
        spaceFunding: "core funding",
        spaceAdjacent_one: "adjacent project",
        spaceAdjacent_other: "adjacent projects",
        ...
        doorAnalyseDesc: "“Where does hydrogen money go?” — five angles, slid",
  ...
  fr: {
    translation: {
      ...
      home: {
        spaceKicker: "La lentille spatiale",
        spaceTitle: "Le secteur spatial, identifié dans le corpus",
        spaceLead:
          "Une lentille versionnée tague chaque projet sur pièces — le spatial au cœur, les technologies habilitantes en adjacent. Rien de gonflé, rien de supprimé.",
        spaceCore_one: "projet spatial au cœur",
        spaceCore_other: "projets spatiaux au cœur",
        spaceFunding: "de financements cœur",
        spaceAdjacent_one: "projet adjacent",
        spaceAdjacent_other: "projets adjacents",
        ...
        doorAnalyseDesc: "« Où va l'argent de l'hydrogène ? » — cinq angles, glissés",
