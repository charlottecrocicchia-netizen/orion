  ...
  en: {
    translation: {
      ...
      calls: {
        ...
        programmeFilter: "Framework programme",
        ...
        truncated: "Showing {{shown}} of {{total}} — narrow with search or filters.",
        opens: "opens {{date}}",
  ...
  fr: {
    translation: {
      ...
      calls: {
        ...
        programmeFilter: "Programme-cadre",
        ...
        truncated: "{{shown}} affichés sur {{total}} — resserrez avec la recherche ou les filtres.",
        opens: "ouvre le {{date}}",
