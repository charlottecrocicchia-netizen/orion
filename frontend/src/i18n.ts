  ...
  en: {
    translation: {
      ...
      explorer: {
        ...
        views: { auto: "Auto", lines: "Lines", bump: "Ranks", delta: "Before / after", bars: "Bars", treemap: "Treemap", map: "Map", table: "Table" },
        bumpTop: "no. 1",
        deltaNew: "new",
  ...
  fr: {
    translation: {
      ...
      explorer: {
        ...
        views: { auto: "Auto", lines: "Courbes", bump: "Rangs", delta: "Avant / après", bars: "Barres", treemap: "Treemap", map: "Carte", table: "Table" },
        bumpTop: "n° 1",
        deltaNew: "nouveau",
