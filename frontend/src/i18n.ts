    ...
    translation: {
      nav: {
        ...
        menu: {
          ...
          moneyTrailDesc: "follow the money — funder, programme, call, project, organisations",
          nsfObligationsDesc:
      ...
      money: {
        ...
        measureShort: {
          ...
          nih_obligations_window_sum: "NIH annual obligations (sum)",
          nih_obligations_window_sum_sum: "NIH annual obligations (observed sum)",
          nsf_obligated_cumulative: "Cumulative obligation at ingestion date",
          nsf_obligated_cumulative_sum: "NSF cumulative obligations (observed sum)",
          ec_contribution: "EU contribution (share)",
          ec_contribution_sum: "Observed EU contributions (shares)",
          nsf_award_obligated: "Constituent award obligation",
          nsf_awards_obligated_sum: "NSF award obligations (sum)",
          nih_beneficiary_projects_total: "NIH projects as beneficiary (not a breakdown)",
        ...
        columns: {
          others_one: "+ {{n}} more · {{amount}}",
          others_other: "+ {{n}} more · {{amount}}",
          othersNoAmount_one: "+ {{n}} more",
        ...
        shareOf: "{{pct}} of {{parent}}",
        ofParent: "of {{parent}}",
        ofProject: "{{pct}} of project",
        ofProjectFull: "{{pct}} of the project total",
        rootGesture: "Choose a funder to start following the money.",
        rootProjects_one: "{{n}} project or award",
        rootProjects_other: "{{n}} projects and awards",
        listUnknown_one: "{{n}} entry carries no known amount — shown as unknown, never as zero.",
        listUnknown_other: "{{n}} entries carry no known amount — shown as unknown, never as zero.",
        orgLead: "Observed public funding, by funder — each block in its own measure and currency.",
        title: "Where did this money go?",
        lead: "Follow public research money level by level — funder, programme, call, project, organisations, countries. Each figure travels with its accounting nature and its provenance; the chain only goes as deep as each source really allows.",
        levels: {
          funder: "Funder",
          programme: "Programme",
        ...
        measure: {
          ec_max_contribution: "EU maximum contribution (grant agreement)",
          ec_max_contribution_sum: "Sum of EU maximum contributions observed in the Orion corpus",
          nih_obligations_window_sum: "Sum of published annual obligations (FY2005+ window)",
          nih_obligations_window_sum_sum: "Sum of NIH annual obligations observed in the Orion corpus (FY2005+ window)",
          nsf_obligated_cumulative: "Cumulative obligation at ingestion date",
          nsf_obligated_cumulative_sum: "Sum of NSF cumulative obligations observed in the Orion corpus",
          ec_contribution: "EU contribution of this participant",
          ec_contribution_sum: "Sum of this entity's observed EU contributions (source shares)",
          nsf_award_obligated: "Cumulative obligation of the constituent award",
          nsf_awards_obligated_sum: "Sum of the entity's NSF award obligations",
          nih_beneficiary_projects_total: "Sum of NIH projects where the entity is the beneficiary (not a breakdown — the beneficiary carries the full project total)",
          nsf_obligation_fy: "NSF annual obligation (official snapshot, per fiscal year)",
          total_cost: "Total project cost, co-funding included",
        },
        nature: {
          source_fact: "source fact",
          derived: "derived",
          orion_analysis: "Orion analysis",
        },
        natureHint: {
          source_fact: "Value published as such by the source.",
          derived: "Deterministic computation from source facts (sum, currency counter-value, recovered attachment).",
          orion_analysis: "Interpretation produced by Orion (classification, grouping).",
        },
        unknownAmount: "Amount unknown — the source does not publish it. Unknown never becomes zero.",
        unknown: "unknown",
        notAvailable: "not available",
        coverageLine_one: "Sum over {{projects}} projects, of which {{unknown}} carries no known amount — it is counted, never turned into a zero.",
        coverageLine_other: "Sum over {{projects}} projects, of which {{unknown}} carry no known amount — they are counted, never turned into zeros.",
        coverageFull: "Sum over {{projects}} projects, all with a known amount.",
        sumObserved: "A sum observed in the Orion corpus — never a budget.",
        emptyLevel: "Nothing at this level.",
        children: {
          programme_one: "Programme",
          programme_other: "Programmes",
          call_one: "Call for proposals",
          call_other: "Calls for proposals",
          project_one: "Project",
          project_other: "Projects",
          participation_one: "Participant",
        ...
        directlyOnParent_one: "{{n}} project sits directly on this programme, outside any child listed above.",
        directlyOnParent_other: "{{n}} projects sit directly on this programme, outside any child listed above.",
        noCallProjects_one: "{{n}} project has no identified call.",
        noCallProjects_other: "{{n}} projects have no identified call.",
        programmeSemantics: {
          ec: "EU programmes are budget lines (CORDIS legalBasis).",
          nih: "NIH programmes are the administering institutes.",
          nsf: "NSF programmes are the NSF divisions.",
        },
        funderNames: {
        ...
        notBudget: "This sum is what the corpus observes for this programme — it is not the programme's budget.",
        notEnvelope: "This sum is what the corpus observes for this call's funded projects — it is not the call's envelope.",
        callReconstructed: "The programme–call link is reconstructed through projects (the source publishes no key); a cross-cutting call serves several programmes.",
        callContextNote: "Scoped view: only this programme's projects are counted here.",
        callContextAll: "See the whole call",
        callTransversal_other: "Cross-cutting call: it serves {{count}} programmes. Its overall total never appears under a single programme — that would double-count.",
        callProgrammesServed: "Programmes served:",
        nih: {
          beneficiaryNote: "NIH publishes no per-organisation share: this row identifies the beneficiary. It is not a financial breakdown — the project total lives above, once.",
          noBeneficiary: "No beneficiary organisation is published for this project.",
        },
        nsf: {
          systemsTitle: "Two measure systems — never added, never interchanged",
          period: "Period:",
          cumulativeProvenance: "NSF awards API (awd_amount)",
          notDecomposition: "These two values are not a decomposition of one another — different windows, different measure systems. They coexist, each with its own nature and period.",
          cumulativeNote: "Whole award, since its start, at ingestion date.",
          windowNote: "Official snapshot, FY2011+ window only.",
          fy: "Fiscal year",
          obligation: "Obligation",
          vintage: "Official snapshot vintage {{vintage}} — restated series add a vintage, never rewrite one.",
        },
        reconciliation: {
          ...
          excess: "Gap",
          gapShare: "{{pct}} of the amount is not broken down in the published participations.",
          unknownChildren: "Participants with unknown share",
          notApplicable: "nothing to reconcile here: the NIH participation is a beneficiary marker, not a financial breakdown.",
          status: {
            exact: "The known shares add up exactly to the project total.",
            gap: "The published shares do not cover the whole project total — a gap is a property of the source data, not an error.",
            gap_zero_one: "The known shares add up to the project total, but {{count}} participant has no published share — the source does not guarantee completeness.",
            gap_zero_other: "The known shares add up to the project total, but {{count}} participants have no published share — the source does not guarantee completeness.",
            children_exceed_parent: "The published shares exceed the project ceiling — this happens in the source data (e.g. co-funded partnerships) and is shown as is.",
            no_parent_amount: "The project total is unknown; the shares cannot be reconciled against it.",
            no_children_amounts: "No participant share is published; nothing to reconcile against the total.",
            not_applicable: "Nothing to reconcile at this level.",
          },
        },
        totalCost: "Total project cost (co-funding included):",
        totalCostZeroHint: "The source published 0 where the cost is simply not filled in — Orion reads it as not available, never as a real zero cost.",
        attributionSource: "Programme attachment: literal source fact (legalBasis).",
        attributionDirect: "Programme attachment: direct source field (institute/division).",
        attributionDerived: "Programme attachment: deterministic Orion derivation (recovered from legalBasis.csv, common-ancestor rule) — not a literal source fact.",
        eurObservedNote: "EUR counter-value at the ECB annual rate of the project's start year — a rate assumption, not an observation.",
        methodology: {
          ...
          source: "Source:",
          eurObserved: "Observed EUR:",
          programmeSemantics: "Programme level:",
          comparability: "Comparability:",
          notBudget: "Scope:",
          callLink: "Programme–call link:",
          dedup: "Organisations:",
          country: "Country level:",
          aboutData: "About the data",
        },
        noTotalTitle: "No single total.",
        noTotalBody: "Accounting natures and currencies differ between funders — one combined figure would be an invented number. Each block stays in its own measure and currency.",
        orgProjects_one: "{{n}} project",
        orgProjects_other: "{{n}} projects",
        orgParticipations_one: "{{n}} participation",
        orgParticipations_other: "{{n}} participations",
        orgUnknownCount: "{{n}} with unknown amount",
        unknownShare: "Share unknown — the source publishes no amount for this participation.",
        countryOrgs: "{{n}} organisations observed in this country",
        countryDestination: "Country of the participating organisation — an institutional destination, never a place of performance nor a national effort.",
        dedupNote: "The organisation is deduplicated across sources — that identity is an Orion analysis.",
        projectSheet: "Open the project sheet",
        orgSheet: "Open the organisation profile",
        countrySheet: "Open the country hub",
        notFound: "This node does not exist.",
        notFoundHint: "The identifier may be wrong, or the object left the corpus.",
        error: "This view could not be loaded.",
        errorHint: "Try again, or come back later.",
        retry: "Retry",
        backToRoot: "Back to the money trail",
      },
    ...
    translation: {
      nav: {
        ...
        menu: {
          ...
          moneyTrail: "Chaîne de l'argent",
          moneyTrailDesc: "suivre l'argent — financeur, programme, appel, projet, organisations",
          nsfObligationsDesc:
      ...
      footer: {
        ...
        moneyTrailLink: "Chaîne de l'argent",
      ...
      money: {
        ...
        measureShort: {
          ...
          nih_obligations_window_sum: "Obligations annuelles NIH (somme)",
          nih_obligations_window_sum_sum: "Obligations annuelles NIH (somme observée)",
          nsf_obligated_cumulative: "Obligation cumulée à la date d'ingestion",
          nsf_obligated_cumulative_sum: "Obligations cumulées NSF (somme observée)",
          ec_contribution: "Contribution UE (part)",
          ec_contribution_sum: "Contributions UE observées (parts)",
          nsf_award_obligated: "Obligation de l'award constituant",
          nsf_awards_obligated_sum: "Obligations des awards NSF (somme)",
          nih_beneficiary_projects_total: "Projets NIH en bénéficiaire (pas une ventilation)",
        ...
        columns: {
          others_one: "+ {{n}} autre · {{amount}}",
          others_other: "+ {{n}} autres · {{amount}}",
          othersNoAmount_one: "+ {{n}} autre",
          othersNoAmount_other: "+ {{n}} autres",
          othersTitle: "Ouvrir la liste complète",
          floored: "Affichée au plancher de visibilité — la part réelle est {{pct}}.",
        ...
        shareOf: "{{pct}} de {{parent}}",
        ofParent: "de {{parent}}",
        ofProject: "{{pct}} du projet",
        ofProjectFull: "{{pct}} du total du projet",
        rootGesture: "Choisissez un financeur pour commencer à suivre l'argent.",
        rootProjects_one: "{{n}} projet ou award",
        rootProjects_other: "{{n}} projets et awards",
        listUnknown_one: "{{n}} entrée est sans montant connu — affichée inconnue, jamais en zéro.",
        listUnknown_other: "{{n}} entrées sont sans montant connu — affichées inconnues, jamais en zéro.",
        orgLead: "Financements publics observés, par financeur — chaque bloc dans sa mesure et sa devise.",
        title: "Où est passé cet argent ?",
        lead: "Suivez l'argent public de la recherche étage par étage — financeur, programme, appel, projet, organisations, pays. Chaque chiffre voyage avec sa nature comptable et sa provenance ; la chaîne ne descend que là où chaque source le permet vraiment.",
        levels: {
          funder: "Financeur",
          programme: "Programme",
        ...
        measure: {
          ec_max_contribution: "Contribution maximale UE (convention de subvention)",
          ec_max_contribution_sum: "Somme des contributions maximales UE observées dans le corpus Orion",
          nih_obligations_window_sum: "Somme des obligations annuelles publiées (fenêtre FY2005+)",
          nih_obligations_window_sum_sum: "Somme des obligations annuelles NIH observées dans le corpus Orion (fenêtre FY2005+)",
          nsf_obligated_cumulative: "Obligation cumulée à la date d'ingestion",
          nsf_obligated_cumulative_sum: "Somme des obligations cumulées NSF observées dans le corpus Orion",
          ec_contribution: "Contribution UE de ce participant",
          ec_contribution_sum: "Somme des contributions UE observées de cette entité (parts source)",
          nsf_award_obligated: "Obligation cumulée de l'award constituant",
          nsf_awards_obligated_sum: "Somme des obligations des awards NSF de l'entité",
          nih_beneficiary_projects_total: "Somme des projets NIH dont l'entité est bénéficiaire (pas une ventilation — le bénéficiaire porte le total du projet)",
          nsf_obligation_fy: "Obligation annuelle NSF (snapshot officiel, par exercice fédéral)",
          total_cost: "Coût total du projet, cofinancements inclus",
        },
        nature: {
          source_fact: "fait source",
          derived: "dérivé",
          orion_analysis: "analyse Orion",
        },
        natureHint: {
          source_fact: "Valeur publiée telle quelle par la source.",
          derived: "Calcul déterministe à partir de faits source (somme, contre-valeur de devise, rattachement recouvré).",
          orion_analysis: "Interprétation produite par Orion (classement, regroupement).",
        },
        unknownAmount: "Montant inconnu — la source ne le publie pas. L'inconnu ne devient jamais zéro.",
        unknown: "inconnu",
        notAvailable: "non disponible",
        coverageLine_one: "Somme sur {{projects}} projets, dont {{unknown}} sans montant connu — il est compté, jamais transformé en zéro.",
        coverageLine_other: "Somme sur {{projects}} projets, dont {{unknown}} sans montant connu — ils sont comptés, jamais transformés en zéros.",
        coverageFull: "Somme sur {{projects}} projets, tous à montant connu.",
        sumObserved: "Une somme observée dans le corpus Orion — jamais un budget.",
        emptyLevel: "Rien à cet étage.",
        children: {
          programme_one: "Programme",
          programme_other: "Programmes",
          call_one: "Appel à propositions",
          call_other: "Appels à propositions",
          project_one: "Projet",
          project_other: "Projets",
          participation_one: "Participant",
          participation_other: "Participants",
        ...
        directlyOnParent_one: "{{n}} projet est rattaché directement à ce programme, hors des enfants listés ci-dessus.",
        directlyOnParent_other: "{{n}} projets sont rattachés directement à ce programme, hors des enfants listés ci-dessus.",
        noCallProjects_one: "{{n}} projet est sans appel identifié.",
        noCallProjects_other: "{{n}} projets sont sans appel identifié.",
        programmeSemantics: {
          ec: "Les programmes UE sont des lignes budgétaires (legalBasis CORDIS).",
          nih: "Les programmes NIH sont les instituts adjudicateurs.",
          nsf: "Les programmes NSF sont les divisions NSF.",
        },
        funderNames: {
        ...
        notBudget: "Cette somme est ce que le corpus observe pour ce programme — ce n'est pas le budget du programme.",
        notEnvelope: "Cette somme est ce que le corpus observe pour les projets lauréats de cet appel — ce n'est pas l'enveloppe de l'appel.",
        callReconstructed: "Le lien programme–appel est reconstruit via les projets (la source ne publie pas de clé) ; un appel transversal sert plusieurs programmes.",
        callContextNote: "Vue cadrée : seuls les projets de ce programme sont comptés ici.",
        callContextAll: "Voir l'appel entier",
        callTransversal_other: "Appel transversal : il sert {{count}} programmes. Son total global n'apparaît jamais sous un seul programme — ce serait un double compte.",
        callProgrammesServed: "Programmes servis :",
        nih: {
          beneficiaryNote: "NIH ne publie aucune part par organisation : cette ligne identifie le bénéficiaire. Ce n'est pas une ventilation financière — le total du projet vit au-dessus, une seule fois.",
          noBeneficiary: "Aucune organisation bénéficiaire n'est publiée pour ce projet.",
        },
        nsf: {
          systemsTitle: "Deux systèmes de mesure — jamais additionnés, jamais interchangés",
          period: "Période :",
          cumulativeProvenance: "API NSF awards (awd_amount)",
          notDecomposition: "Ces deux valeurs ne constituent pas une décomposition l'une de l'autre — fenêtres et systèmes de mesure différents. Elles coexistent, chacune avec sa nature et sa période.",
          cumulativeNote: "L'award entier, depuis son début, à la date d'ingestion.",
          windowNote: "Snapshot officiel, fenêtre FY2011+ uniquement.",
          fy: "Exercice fédéral",
          obligation: "Obligation",
          vintage: "Millésime du snapshot officiel {{vintage}} — une série restatée ajoute un millésime, n'en réécrit jamais un.",
        },
        reconciliation: {
          ...
          unallocated: "Non ventilé",
          ceiling: "Plafond du projet",
          excess: "Écart",
          gapShare: "{{pct}} du montant n'est pas ventilé dans les participations publiées.",
          unknownChildren: "Participants à part inconnue",
          notApplicable: "rien à réconcilier ici : la participation NIH identifie un bénéficiaire, pas une ventilation financière.",
          status: {
            exact: "Les parts connues totalisent exactement le total du projet.",
            gap: "Les parts publiées ne couvrent pas tout le total du projet — un écart est une propriété des données sources, pas une erreur.",
            gap_zero_one: "Les parts connues totalisent le total du projet, mais {{count}} participant n'a pas de part publiée — la source ne garantit pas l'exhaustivité.",
            gap_zero_other: "Les parts connues totalisent le total du projet, mais {{count}} participants n'ont pas de part publiée — la source ne garantit pas l'exhaustivité.",
            children_exceed_parent: "Les parts publiées dépassent le plafond du projet — cela arrive dans les données sources (partenariats cofinancés, par exemple) et s'affiche tel quel.",
            no_parent_amount: "Le total du projet est inconnu ; les parts ne peuvent pas s'y réconcilier.",
            no_children_amounts: "Aucune part de participant n'est publiée ; rien à réconcilier contre le total.",
            not_applicable: "Rien à réconcilier à cet étage.",
          },
        },
        totalCost: "Coût total du projet (cofinancements inclus) :",
        totalCostZeroHint: "La source a publié 0 là où le coût n'est simplement pas renseigné — Orion le lit comme non disponible, jamais comme un vrai coût nul.",
        attributionSource: "Rattachement au programme : fait source littéral (legalBasis).",
        attributionDirect: "Rattachement au programme : champ source direct (institut/division).",
        attributionDerived: "Rattachement au programme : dérivé déterministe Orion (recouvré depuis legalBasis.csv, règle de l'ancêtre commun) — pas un fait source littéral.",
        eurObservedNote: "Contre-valeur EUR au taux annuel BCE de l'année de début du projet — une hypothèse de taux, pas une observation.",
        methodology: {
          ...
          source: "Source :",
          eurObserved: "EUR observé :",
          programmeSemantics: "Étage programme :",
          comparability: "Comparabilité :",
          notBudget: "Périmètre :",
          callLink: "Lien programme–appel :",
          dedup: "Organisations :",
          country: "Étage pays :",
          aboutData: "À propos des données",
        },
        noTotalTitle: "Pas de total unique.",
        noTotalBody: "Les natures comptables et les devises diffèrent entre financeurs — un chiffre combiné serait un nombre inventé. Chaque bloc reste dans sa mesure et sa devise.",
        orgProjects_one: "{{n}} projet",
        orgProjects_other: "{{n}} projets",
        orgParticipations_one: "{{n}} participation",
        orgParticipations_other: "{{n}} participations",
        orgUnknownCount: "{{n}} à montant inconnu",
        unknownShare: "Part inconnue — la source ne publie aucun montant pour cette participation.",
        countryOrgs: "{{n}} organisations observées dans ce pays",
        countryDestination: "Pays de l'organisation participante — une destination institutionnelle, jamais un lieu d'exécution ni un effort national.",
        dedupNote: "L'organisation est dédupliquée entre sources — cette identité est une analyse Orion.",
        projectSheet: "Ouvrir la fiche projet",
        orgSheet: "Ouvrir le profil de l'organisation",
        countrySheet: "Ouvrir le hub pays",
        notFound: "Ce nœud n'existe pas.",
        notFoundHint: "L'identifiant est peut-être erroné, ou l'objet a quitté le corpus.",
        error: "Cette vue n'a pas pu être chargée.",
        errorHint: "Réessayez, ou revenez plus tard.",
        retry: "Réessayer",
        backToRoot: "Retour à la chaîne de l'argent",
      },
