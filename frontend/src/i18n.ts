  ...
  en: {
    translation: {
      ...
      explorer: {
        ...
        views: { auto: "Auto", lines: "Lines", bump: "Ranks", bars: "Bars", treemap: "Treemap", map: "Map", table: "Table" },
        bumpTop: "no. 1",
        angles: {
        ...
        stories: {
          hydrogen: { a1: "The trajectory", a2: "By programme", a3: "By country", a4: "Who gets funded", a5: "The country race (ranks)",
          ...
          themeRace: { a1: "The race, in curves", a2: "The race, in ranks", a3: "The cumulative standings",
  ...
  fr: {
    translation: {
      ...
      explorer: {
        ...
        views: { auto: "Auto", lines: "Courbes", bump: "Rangs", bars: "Barres", treemap: "Treemap", map: "Carte", table: "Table" },
        bumpTop: "n° 1",
        angles: {
        ...
        stories: {
          hydrogen: { a1: "La trajectoire", a2: "Par programme", a3: "Par pays", a4: "Qui est financé", a5: "La course des pays (rangs)",
          ...
          themeRace: { a1: "La course, en courbes", a2: "La course, en rangs", a3: "Le cumul",
