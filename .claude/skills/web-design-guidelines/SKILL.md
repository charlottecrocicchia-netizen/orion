...
description: Web Interface Guidelines (Vercel Labs, MIT) — règles MUST/SHOULD/NEVER pour des interfaces accessibles, rapides et soignées. À charger avant d'écrire ou de revoir du code UI (composants React, pages, formulaires, focus, animations, layout) et lors des revues de design de la phase 2+ d'Orion.
---

# Web Interface Guidelines

Source officielle : https://github.com/vercel-labs/web-interface-guidelines (MIT).
Appliquer ces règles à toute UI produite pour Orion ; en cas de conflit, la
direction artistique validée par la fondatrice prime sur les préférences
esthétiques, jamais sur l'accessibilité.
